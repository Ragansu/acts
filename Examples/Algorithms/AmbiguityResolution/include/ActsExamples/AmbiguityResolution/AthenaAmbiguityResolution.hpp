...
private:
  std::map<unsigned int,DectectorConfig> m_volumeMap {
    {16,{20, 10, 2, 0, 1000, 2, 100, 0}}, // pixel 1
    {17,{20, 10, 2, 0, 1000, 2, 100, 0}}, // pixel 2
    {18,{20, 10, 2, 0, 1000, 2, 10, 0}}, // pixel 3

    {23,{15, 8, 2, 0, 1000, 2, 100, 1}}, // short strip 1
    {24,{15, 8, 2, 0, 1000, 2, 100, 1}}, // short strip 2
    {25,{15, 8, 2, 0, 1000, 2, 100, 1}}, // short strip 3

    {28,{10, 5, 2, 0, 1000, 2, 100, 2}}, // long strip 1
    {29,{10, 5, 2, 0, 1000, 2, 100, 2}}, // long strip 2
    {30,{10, 5, 2, 0, 1000, 2, 100, 2}} // long strip 3
